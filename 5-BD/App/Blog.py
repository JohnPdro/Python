...
def add_post() :
    ...
    user = session.query(User).filter_by(id=author_id).first() # Faz uma query na tabela User que vai filtrar pelo id de User onde seja igual ao id do Author e pega o primeiro registro
    if user :
